...
export function Team(props) {
  return (
    <div className="mx-auto max-w-7xl px-2 md:px-0 mb-16">
      <div className="my-4">
        <h1 className="text-3xl font-bold text-black">Our Team</h1>
        ...
        <div className="flex flex-col items-center text-start">
          ...
          >
            ...
            <div className="absolute bottom-4 left-4">
              <h1 className="text-xl font-semibold text-white">{props.userName}</h1>
